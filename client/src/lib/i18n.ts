  ...
  en: {
    translation: {
      ...
      scanner: {
        ...
        grandTotal: 'Grand Total (incl. GST)',
        subTotal: 'Sub Total',
        tax: 'GST',
        pickItem: 'Tap your dish to itemize',
        useFullTotal: 'Use full bill total',
  ...
  ml: {
    translation: {
      ...
      scanner: {
        ...
        grandTotal: 'മൊത്തം (ജിഎസ്ടി ഉൾപ്പെടെ)',
        subTotal: 'ഉപമൊത്തം',
        tax: 'ജിഎസ്ടി',
        pickItem: 'നിങ്ങളുടെ വിഭവം തിരഞ്ഞെടുക്കൂ',
        useFullTotal: 'മുഴുവൻ ബിൽ തുക ഉപയോഗിക്കുക',
      },
    },
  },
  hi: {
    translation: {
      ...
      scanner: {
        ...
        grandTotal: 'ग्रैंड टोटल (जीएसटी सहित)',
        subTotal: 'सब टोटल',
        tax: 'जीएसटी',
        pickItem: 'अपना व्यंजन चुनें',
        useFullTotal: 'पूरा बिल योग उपयोग करें',
